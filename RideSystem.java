    ...
    public static void main(String[] args) {
        ...
        for (Vehicle vehicle : vehicles) {
            ...
            if (vehicle instanceof GPS) {
                ...
                gpsVehicle.updateLocation("New Location ABC");
            }
...
//Driver Name: Harman
//Rate per Km: $1.5
//Fare for 10 km ride: 15.0
//Car is currently at XYZ location.
//Car location updated to: New Location ABC
//----------------------------------------
//Vehicle ID: V002
//Driver Name: Aaryan
//Rate per Km: $0.8
//Fare for 10 km ride: 8.0
//Bike is currently at ABC location.
//Bike location updated to: New Location ABC
//----------------------------------------
//Vehicle ID: V003
//Driver Name: Anish
//Rate per Km: $1.0
//Fare for 10 km ride: 10.0
//Auto is currently at DEF location.
//Auto location updated to: New Location ABC
//----------------------------------------