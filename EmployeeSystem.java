...
public class EmployeeSystem {
    public static void main(String[] args) {
        // Create employees
        FullTimeEmployee fullTimeEmp = new FullTimeEmployee(1, "Harman", 50000);
        PartTimeEmployee partTimeEmp = new PartTimeEmployee(2, "Ansh", 30000, 30);

        // Create department instance
        EmployeeDepartment dept = new EmployeeDepartment("TECH Department");
